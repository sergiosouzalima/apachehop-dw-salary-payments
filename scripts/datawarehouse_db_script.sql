...
DROP TABLE IF EXISTS public.FATO_SALARIO;

CREATE TABLE public.FATO_SALARIO(
  ...
  --VL_FUNCIONARIO_SALARIO NUMERIC(18,2) NOT NULL, 
  CONSTRAINT FATO_SALARIO_PK PRIMARY KEY(ID_FATO)
);
